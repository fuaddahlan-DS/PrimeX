...
<body id="page-top" class="index relative-position"> 
    ...
    <section id="about" class=" relative-position">
        ...
        <img src="/img_/primexlogo.png" alt="PrimeX Detailing" style="width: 100%;">
            ...
            <div class="container"> 
                <div class="row">
                    <h2 class="section-heading text-center error ">ACCESS DENIED</h2>
                </div> 
    ...
    margin: 0 !important;">You don't have access to this area. <br /><br />Please contact your administrator</p>
                    <br />
                    <br />
                    <br />
