            ...
            <div class="panel-default">  
                <div class="row">
                    <div class="col-md-12 col-xs-12 col-sm-12 m-xs-b-1">
                        <div class="col-md-2 col-xs-6 col-sm-4 p-l-0"><label>Vehicle Number</label></div>
                    ...
                    <div class="col-md-12 col-xs-12 p-xs-l-0 p-xs-r-0">
                        <header class="panel-heading custom-tab ">
                            <ul class="nav nav-tabs nav-justified">
                                ...
                                <li id="pg5" class="">
                                    <a href="#bi" data-toggle="tab" class="disabled" onclick="$('#buttonbill').removeClass('hide');">Billing Info</a>
                                </li>
                                <li id="pg6" class="">
                        ...
                        <div class="panel-body-tabs">
                            <form action="{{ URL::route('add_new_job') }}" method="post" id="add_new_job_form" class="form-horizontal adminex-form">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="vd">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-xs-12 col-sm-12 m-xs-b-1">
                                            <div class="col-md-2 col-xs-6 col-sm-4 p-l-0"><label>Model</label></div>
                                ...
                                <div class="tab-pane" id="od">
                                    <div class="row">
                                        <div class="col-md-12 col-xs-12 col-sm-12 m-xs-b-1">
                                            <div class="col-md-2 col-xs-6 col-sm-4 p-l-0"><label>Member ID</label></div>
                                            <div id="odMemberCode" class="col-md-10 col-xs-6 col-sm-8 p-l-0 word-wrap">{{ $MemberID }}</div>
                                        </div>

                                        <div class="col-md-12 col-xs-12 col-sm-12 m-xs-b-1">
                                            <div class="col-md-2 col-xs-6 col-sm-4 p-l-0"><label>Member Name</label></div>
                                            <div id="odMemberName" class="col-md-10 col-xs-6 col-sm-8 p-l-0 word-wrap">{{ $Client->Name }}</div>
                                        </div>
                                ...
                                <div class="tab-pane" id="rfl">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <div class="form-group"> 
                                                <div class="col-md-4 col-md-offset-4 text-center">
                                                    <button type="button" class="btn btn-success btn-block" id="SaveNewJob"><i class="fa fa-play"></i> Start New Job</button>
                                                </div>
                                            </div> 
                                        </div>
                                    </div>
...
<script type="text/javascript">   
    ...
    $(document).ready(function () {
        ...
        $('#SaveNewJob').click(function() {
            var topupBalance = $('.ownerbalance').html();

            if (topupBalance == '0.00') {
                alert('Please topup first before proceeding');

                return false;
            }
            else {
                $('#add_new_job_form').submit();
            }
        });
